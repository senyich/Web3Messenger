...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(new \App\Service\UserService($a, new \App\Service\SecurityService($container->getEnv('SECRET_KEY'))), $a, ($container->privates['serializer'] ?? self::getSerializerService($container)));
